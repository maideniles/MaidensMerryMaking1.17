...
public class Disc2DungeonModifier extends LootModifier {
    ...
    protected Disc2DungeonModifier(LootItemCondition[] conditionsIn, Item addition) {
        super(conditionsIn);
    ...
    public static class Serializer extends GlobalLootModifierSerializer<Disc2DungeonModifier> {
        ...
        @Override
        public Disc2DungeonModifier read(ResourceLocation name, JsonObject object, LootItemCondition[] conditionsIn) {
